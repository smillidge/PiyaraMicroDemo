...
public class Alphabet {
    ...
    private static final Logger s_logger = Logger.getLogger(Alphabet.class.getName());
    ...
    public Alphabet(URL url) {
        ...
        try {
            ...
            s_logger.log(Level.SEVERE,"Error in opening Alphabet file.", e);
        } finally {
            if (is != null) {
                try {
                    is.close();
                } catch (IOException e) {
                    s_logger.log(Level.SEVERE,"Error in closing stream.", e);
                }
            }
        }
    }
