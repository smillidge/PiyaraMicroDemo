...
public class Colors {
    ...
    public static final short[] PAYARA_ORANGE = { 27, 152, 240 };
    public static final short[] PAYARA_BLUE = { 62, 44, 0 };
    public static final short[] YELLOW = { 0, 255, 255 };
    public static final short[] GREEN = { 0, 255, 0 };
    public static final short[] BLUE = { 255, 0, 0 };
    public static final short[] SEA_BLUE = { 255, 178, 102 };
    ...
    public static final short[] GREY = { 160, 160, 160 };
    public static final short[] DARKGREY = { 90, 90, 90 };
