...
public class LSM9DS1 {
    ...
    private static final Logger s_logger = Logger.getLogger(LSM9DS1.class.getName());
    ...
    public static int read(int device, int register) throws Exception {
        int result = 0;
        try {
            if (device == 0) {
    ...
    public static void write(int device, int register, byte[] value) throws Exception {
        try {
    ...
    public static void disableGyroscope() {
        ...
        try {
            ...
            s_logger.log(Level.SEVERE,"Can't write to the device.", e);
        }
